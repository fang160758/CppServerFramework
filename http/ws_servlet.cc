...
int32_t FunctionWSServlet::onConnect(fang::http::HttpRequest::ptr header
         , fang::http::WSSession::ptr session) {
     if (m_onConnect) {
...
int32_t FunctionWSServlet::onClose(fang::http::HttpRequest::ptr header
         , fang::http::WSSession::ptr session) {
     if (m_onClose) {
...
int32_t FunctionWSServlet::handle(fang::http::HttpRequest::ptr header
