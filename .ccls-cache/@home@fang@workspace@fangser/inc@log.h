...
#define FANG_LOG_LEVEL(logger, level)    \
    ...
    fang::LogEventWarp(fang::LogEvent::ptr(new fang::LogEvent((logger), (level), __FILE__, __LINE__, 0, fang::GetThreadId(), fang::GetFiberId(), time(0), fang::Thread::GetName()))).getSS()
