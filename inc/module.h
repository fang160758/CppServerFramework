...
public:
    ...
    virtual bool onConnect   (fang::Stream::ptr stream);
    virtual bool onDisconnect(fang::Stream::ptr stream);

    virtual bool onServerReady();
    virtual bool onServerUp();

    virtual bool handleRequest(fang::Message::ptr req
                             , fang::Message::ptr rsp
                             , fang::Stream::ptr stream);

    virtual bool handleNotify(fang::Message::ptr notify
                             , fang::Stream::ptr stream);
...
typedef fang::Singleton<ModuleManager> ModuleMgr;
